...
def getOneQQ(driver, db):
    ...
    # friend = driver.find_element_by_id('aFriendship')
    try:
...
def getData(driver, targetQQ, account, password, targetPage, db):
...
def mian():
    ...
    getData(driver, targetQQ, account, password, targetPage, qzone)
    driver.close()
    driver.quit()
